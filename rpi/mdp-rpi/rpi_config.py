...
STM_NAV_COMMAND_FORMAT = '^(([SLR][FB])|([UY]F)|([IXT][LR]))[0-9]{3}$' # task 2
...
STM_OBS_ROUTING_MAP = {
    ...
    "SECONDLEFT": ["LF090", "SB030", "TR000", "IR100", "RF180", "SF010", "TR000", "XR200", "RF090"],
    "SECONDRIGHT": ["RF090", "SB030", "TL000", "IL100", "LF180", "SF010", "TL000", "XL200", "LF090"]
}
